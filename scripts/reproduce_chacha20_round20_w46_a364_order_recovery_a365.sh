...
RUNNER="research/experiments/chacha20_round20_w46_a364_order_recovery_a365.py"
IMPLEMENTATION="research/configs/chacha20_round20_w46_a364_order_recovery_a365_implementation_v1.json"
ORDER="research/results/v1/chacha20_round20_w46_a362_reader_sealed_a361_order_a364_v1.json"
RESULT="research/results/v1/chacha20_round20_w46_a364_order_recovery_a365_v1.json"
QUALIFICATION="research/results/v1/chacha20_round20_w46_eight_slab_grouped_engine_a324_qualification_v1.json"

.venv/bin/python -m pytest -q \
  tests/test_chacha20_round20_w46_a364_order_recovery_a365.py
