...
- The exact prefix frontier rules out single-coordinate constancy as that
  ...
  round split, using the R2->R3 collapse as the localization boundary.
...
- The ANF frontier localizes the remaining algebraic structure: preserve the
  ...
  variable components.  The influence frontier moves a factorized split to
  R2->R3; keep R3--R24 as a separate constraint component because full symbolic
  substitution reaches all-to-all influence at R4 and random-like ANF density
  at R5.
