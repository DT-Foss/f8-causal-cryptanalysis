#!/usr/bin/env python3
"""A433: build a zero-refit W52 Direct12 order and exact eight-worker schedule."""
...
ARTIFACTS = RESEARCH / "artifacts/a433_chacha20_r20_w52_prefix_aligned_direct12"
MEASUREMENTS = RESULTS / "chacha20_round20_w52_prefix_aligned_direct12_eight_worker_a433_v1"
...
BASE_CNF = ARTIFACTS / "a433_a426_prefix_aligned_w52_b1.cnf"
TEST = ROOT / "tests/test_chacha20_round20_w52_prefix_aligned_direct12_eight_worker_a433.py"
REPRO = ROOT / "scripts/reproduce_chacha20_round20_w52_prefix_aligned_direct12_eight_worker_a433.sh"
...
def freeze_implementation() -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "schema": "chacha20-round20-w52-prefix-aligned-direct12-eight-worker-a433-implementation-v1",
        "attempt_id": ATTEMPT_ID,
        "commitment_state": "complete_W52_measurement_and_eight_worker_schedule_code_frozen_before_any_A433_measurement_candidate_or_A426_result",
...
def load_implementation(expected_sha256: str) -> dict[str, Any]:
    ...
    if (
        value.get("schema")
        != "chacha20-round20-w52-prefix-aligned-direct12-eight-worker-a433-implementation-v1"
        or value.get("attempt_id") != ATTEMPT_ID
...
def preflight(
    *, expected_implementation_sha256: str, expected_a426_protocol_sha256: str
    ...
    if canonical_sha256(synthetic) != correction["synthetic_reader_mapping_sha256"]:
        raise RuntimeError("A433 synthetic mapping differs from A354 correction")
    ...
    payload: dict[str, Any] = {
        "schema": "chacha20-round20-w52-prefix-aligned-direct12-eight-worker-a433-preflight-v1",
        "attempt_id": ATTEMPT_ID,
...
def load_preflight(expected_sha256: str, expected_a426_protocol_sha256: str) -> dict[str, Any]:
    ...
    if (
        value.get("schema")
        != "chacha20-round20-w52-prefix-aligned-direct12-eight-worker-a433-preflight-v1"
...
def measure(
    *,
    ...
    assert_pre_a426_result()
    payload: dict[str, Any] = {
        "schema": "chacha20-round20-w52-prefix-aligned-direct12-eight-worker-a433-result-v1",
        "attempt_id": ATTEMPT_ID,
